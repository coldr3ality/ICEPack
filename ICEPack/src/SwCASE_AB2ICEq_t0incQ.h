...
#define	SwCASE_AB2ICEq_t0incQ( $a, $b, $pq, $postQ)	/*	cast [a, b] to the high side of *pq	w/ (0) byte[s] of overrun tolerance	*/		\
\
...
case 0x42:	/*  3, 0   */	*( (ui16*) ( $pq	) )= $a;									\
						*( (ui08*) ( $pq +2 	) )= $a>>16;								$pq +=  3;	$postQ -=  3;	break;	\
...
case 0x46:	/*  7, 0   */	*( (ui32*) ( $pq	) )= $a;									\
						*( (ui16*) ( $pq +4 	) )= $a>>32;								\
						*( (ui08*) ( $pq +6 	) )= $a>>48;								$pq +=  7;	$postQ -=  7;	break;	\
...
case 0x97:	/*  0, 3   */								*( (ui16*) ( $pq	) )= $b;		\
													*( (ui08*) ( $pq +2 	) )= $b>>16;	$pq +=  3;	$postQ -=  3;	break;	\
case 0x98:	/*  0, 4   */								\
case 0x99:	/*  0, 4   */								\
case 0x9A:	/*  0, 4   */								\
case 0x9B:	/*  0, 4   */								\
...
case 0xB7:	/*  0, 7   */								*( (ui32*) ( $pq	) )= $b;		\
													*( (ui16*) ( $pq +4 	) )= $b>>32;	\
													*( (ui08*) ( $pq +6 	) )= $b>>48;	$pq +=  7;	$postQ -=  7;	break;	\
case 0xB8:	/*  0, 8   */								\
case 0xB9:	/*  0, 8   */								\
case 0xBA:	/*  0, 8   */								\
case 0xBB:	/*  0, 8   */								\
...
case 0xC5:	/*  6, 1   */	*( (ui32*) ( $pq	) )= $a;									\
						*( (ui16*) ( $pq +4 	) )= $a>>32;	*( (ui08*) ( $pq +6 	) )= $b;		$pq +=  7;	$postQ -=  7;	break;	\
...
case 0xCC:	/*  5, 2   */	*( (ui32*) ( $pq	) )= $a;									\
						*( (ui08*) ( $pq +4 	) )= $a>>32;	*( (ui16*) ( $pq +5 	) )= $b;		$pq +=  7;	$postQ -=  7;	break;	\
...
case 0xD0:	/*  1, 3   */	*( (ui08*) ( $pq	) )= $a;		*( (ui16*) ( $pq +1 	) )= $b;		\
													*( (ui08*) ( $pq +3 	) )= $b>>16;	$pq +=  4;	$postQ -=  4;	break;	\
case 0xD1:	/*  2, 3   */	*( (ui16*) ( $pq	) )= $a;		*( (ui16*) ( $pq +2 	) )= $b;		\
													*( (ui08*) ( $pq +4 	) )= $b>>16;	$pq +=  5;	$postQ -=  5;	break;	\
case 0xD2:	/*  3, 3   */	*( (ui32*) ( $pq	) )= $a;		*( (ui16*) ( $pq +3 	) )= $b;		\
													*( (ui08*) ( $pq +5 	) )= $b>>16;	$pq +=  6;	$postQ -=  6;	break;	\
case 0xD3:	/*  4, 3   */	*( (ui32*) ( $pq	) )= $a;		*( (ui16*) ( $pq +4 	) )= $b;		\
													*( (ui08*) ( $pq +6 	) )= $b>>16;	$pq +=  7;	$postQ -=  7;	break;	\
case 0xD4:	/*  5, 3   */	*( (ui64*) ( $pq	) )= $a;		*( (ui16*) ( $pq +5 	) )= $b;		\
													*( (ui08*) ( $pq +7 	) )= $b>>16;	$pq +=  8;	$postQ -=  8;	break;	\
case 0xD5:	/*  6, 3   */	*( (ui64*) ( $pq	) )= $a;		*( (ui16*) ( $pq +6 	) )= $b;		\
													*( (ui08*) ( $pq +8 	) )= $b>>16;	$pq +=  9;	$postQ -=  9;	break;	\
case 0xD6:	/*  7, 3   */	*( (ui64*) ( $pq	) )= $a;		*( (ui16*) ( $pq +7 	) )= $b;		\
													*( (ui08*) ( $pq +9 	) )= $b>>16;	$pq += 10;	$postQ -= 10;	break;	\
case 0xD7:	/*  8, 3   */	*( (ui64*) ( $pq	) )= $a;		*( (ui16*) ( $pq +8 	) )= $b;		\
													*( (ui08*) ( $pq +10	) )= $b>>16;	$pq += 11;	$postQ -= 11;	break;	\
...
case 0xF0:	/*  1, 7   */	*( (ui08*) ( $pq	) )= $a;		*( (ui32*) ( $pq +1 	) )= $b;		\
													*( (ui16*) ( $pq +5 	) )= $b>>32;	\
													*( (ui08*) ( $pq +7 	) )= $b>>48;	$pq +=  8;	$postQ -=  8;	break;	\
case 0xF1:	/*  2, 7   */	*( (ui16*) ( $pq	) )= $a;		*( (ui32*) ( $pq +2 	) )= $b;		\
													*( (ui16*) ( $pq +6 	) )= $b>>32;	\
													*( (ui08*) ( $pq +8 	) )= $b>>48;	$pq +=  9;	$postQ -=  9;	break;	\
case 0xF2:	/*  3, 7   */	*( (ui32*) ( $pq	) )= $a;		*( (ui32*) ( $pq +3 	) )= $b;		\
													*( (ui16*) ( $pq +7 	) )= $b>>32;	\
													*( (ui08*) ( $pq +9 	) )= $b>>48;	$pq += 10;	$postQ -= 10;	break;	\
case 0xF3:	/*  4, 7   */	*( (ui32*) ( $pq	) )= $a;		*( (ui32*) ( $pq +4 	) )= $b;		\
													*( (ui16*) ( $pq +8 	) )= $b>>32;	\
													*( (ui08*) ( $pq +10	) )= $b>>48;	$pq += 11;	$postQ -= 11;	break;	\
case 0xF4:	/*  5, 7   */	*( (ui64*) ( $pq	) )= $a;		*( (ui32*) ( $pq +5 	) )= $b;		\
													*( (ui16*) ( $pq +9 	) )= $b>>32;	\
													*( (ui08*) ( $pq +11	) )= $b>>48;	$pq += 12;	$postQ -= 12;	break;	\
case 0xF5:	/*  6, 7   */	*( (ui64*) ( $pq	) )= $a;		*( (ui32*) ( $pq +6 	) )= $b;		\
													*( (ui16*) ( $pq +10	) )= $b>>32;	\
													*( (ui08*) ( $pq +12	) )= $b>>48;	$pq += 13;	$postQ -= 13;	break;	\
case 0xF6:	/*  7, 7   */	*( (ui64*) ( $pq	) )= $a;		*( (ui32*) ( $pq +7 	) )= $b;		\
													*( (ui16*) ( $pq +11	) )= $b>>32;	\
													*( (ui08*) ( $pq +13	) )= $b>>48;	$pq += 14;	$postQ -= 14;	break;	\
case 0xF7:	/*  8, 7   */	*( (ui64*) ( $pq	) )= $a;		*( (ui32*) ( $pq +8 	) )= $b;		\
													*( (ui16*) ( $pq +12	) )= $b>>32;	\
													*( (ui08*) ( $pq +14	) )= $b>>48;	$pq += 15;	$postQ -= 15;	break;	\
