...
/*	ICE encoding is efficient for inside-out UUID tables.  It has O(1) access time to lowest / highest / nearest existing / nonexisting keys.
	...
	As a security enthusiast, I must bore you with words of caution, because even the best tools don't use themselves (yet).
	TODO lol
...
/*	NOTES
	...
	They are generated by the perl scripts in the "srcgen" directory, namely:
		...
		> gen_c_for__qCAST_t[0123].h.pl	*the numbers 0, 1, 2, and 3 are buffer overrun tolerance ratings.
