...
#define	SwCASE_AB2ICEq_t3incQ( $a, $b, $pq, $postQ)	/*	cast [a, b] to the high side of *pq	w/ (3) byte[s] of overrun tolerance	*/		\
\
...
case 0x44:	/*  5, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  5;	$postQ -=  5;	break;	\
case 0x45:	/*  6, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  6;	$postQ -=  6;	break;	\
...
case 0x4C:	/*  5, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  5;	$postQ -=  5;	break;	\
case 0x4D:	/*  6, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  6;	$postQ -=  6;	break;	\
...
case 0x54:	/*  5, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  5;	$postQ -=  5;	break;	\
case 0x55:	/*  6, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  6;	$postQ -=  6;	break;	\
...
case 0x5C:	/*  5, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  5;	$postQ -=  5;	break;	\
case 0x5D:	/*  6, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  6;	$postQ -=  6;	break;	\
...
case 0x64:	/*  5, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  5;	$postQ -=  5;	break;	\
case 0x65:	/*  6, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  6;	$postQ -=  6;	break;	\
...
case 0x6C:	/*  5, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  5;	$postQ -=  5;	break;	\
case 0x6D:	/*  6, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  6;	$postQ -=  6;	break;	\
...
case 0x74:	/*  5, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  5;	$postQ -=  5;	break;	\
case 0x75:	/*  6, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  6;	$postQ -=  6;	break;	\
...
case 0x7C:	/*  5, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  5;	$postQ -=  5;	break;	\
case 0x7D:	/*  6, 0   */	*( (ui64*) ( $pq	) )= $a;									$pq +=  6;	$postQ -=  6;	break;	\
...
case 0xA5:	/*  0, 5   */								\
case 0xA6:	/*  0, 5   */								\
case 0xA7:	/*  0, 5   */								*( (ui64*) ( $pq	) )= $b;		$pq +=  5;	$postQ -=  5;	break;	\
case 0xA8:	/*  0, 6   */								\
case 0xA9:	/*  0, 6   */								\
case 0xAA:	/*  0, 6   */								\
case 0xAB:	/*  0, 6   */								\
...
case 0xAD:	/*  0, 6   */								\
case 0xAE:	/*  0, 6   */								\
case 0xAF:	/*  0, 6   */								*( (ui64*) ( $pq	) )= $b;		$pq +=  6;	$postQ -=  6;	break;	\
case 0xB0:	/*  0, 7   */								\
case 0xB1:	/*  0, 7   */								\
case 0xB2:	/*  0, 7   */								\
case 0xB3:	/*  0, 7   */								\
...
case 0xC4:	/*  5, 1   */	*( (ui64*) ( $pq	) )= $a;		*( (ui08*) ( $pq +5 	) )= $b;		$pq +=  6;	$postQ -=  6;	break;	\
...
case 0xE0:	/*  1, 5   */	*( (ui08*) ( $pq	) )= $a;		*( (ui64*) ( $pq +1 	) )= $b;		$pq +=  6;	$postQ -=  6;	break;	\
case 0xE1:	/*  2, 5   */	*( (ui16*) ( $pq	) )= $a;		*( (ui64*) ( $pq +2 	) )= $b;		$pq +=  7;	$postQ -=  7;	break;	\
case 0xE2:	/*  3, 5   */	*( (ui32*) ( $pq	) )= $a;		*( (ui64*) ( $pq +3 	) )= $b;		$pq +=  8;	$postQ -=  8;	break;	\
case 0xE3:	/*  4, 5   */	*( (ui32*) ( $pq	) )= $a;		*( (ui64*) ( $pq +4 	) )= $b;		$pq +=  9;	$postQ -=  9;	break;	\
case 0xE4:	/*  5, 5   */	*( (ui64*) ( $pq	) )= $a;		*( (ui64*) ( $pq +5 	) )= $b;		$pq += 10;	$postQ -= 10;	break;	\
case 0xE5:	/*  6, 5   */	*( (ui64*) ( $pq	) )= $a;		*( (ui64*) ( $pq +6 	) )= $b;		$pq += 11;	$postQ -= 11;	break;	\
case 0xE6:	/*  7, 5   */	*( (ui64*) ( $pq	) )= $a;		*( (ui64*) ( $pq +7 	) )= $b;		$pq += 12;	$postQ -= 12;	break;	\
case 0xE7:	/*  8, 5   */	*( (ui64*) ( $pq	) )= $a;		*( (ui64*) ( $pq +8 	) )= $b;		$pq += 13;	$postQ -= 13;	break;	\
case 0xE8:	/*  1, 6   */	*( (ui08*) ( $pq	) )= $a;		*( (ui64*) ( $pq +1 	) )= $b;		$pq +=  7;	$postQ -=  7;	break;	\
case 0xE9:	/*  2, 6   */	*( (ui16*) ( $pq	) )= $a;		*( (ui64*) ( $pq +2 	) )= $b;		$pq +=  8;	$postQ -=  8;	break;	\
case 0xEA:	/*  3, 6   */	*( (ui32*) ( $pq	) )= $a;		*( (ui64*) ( $pq +3 	) )= $b;		$pq +=  9;	$postQ -=  9;	break;	\
case 0xEB:	/*  4, 6   */	*( (ui32*) ( $pq	) )= $a;		*( (ui64*) ( $pq +4 	) )= $b;		$pq += 10;	$postQ -= 10;	break;	\
case 0xEC:	/*  5, 6   */	*( (ui64*) ( $pq	) )= $a;		*( (ui64*) ( $pq +5 	) )= $b;		$pq += 11;	$postQ -= 11;	break;	\
case 0xED:	/*  6, 6   */	*( (ui64*) ( $pq	) )= $a;		*( (ui64*) ( $pq +6 	) )= $b;		$pq += 12;	$postQ -= 12;	break;	\
case 0xEE:	/*  7, 6   */	*( (ui64*) ( $pq	) )= $a;		*( (ui64*) ( $pq +7 	) )= $b;		$pq += 13;	$postQ -= 13;	break;	\
case 0xEF:	/*  8, 6   */	*( (ui64*) ( $pq	) )= $a;		*( (ui64*) ( $pq +8 	) )= $b;		$pq += 14;	$postQ -= 14;	break;	\
